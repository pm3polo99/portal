...
void makeArena(const int &n)
{
		  ...
		  if (n == 1)
		  {
					 ...
					 gameFloor = addRect(xres * 1.0f, 0.0f, xres*10.0f, 50.0f, 0.7f, 0.2f, 2, (char *)"floor portalable");
					 gameFloor->SetAwake(false);

					 ((b2Body *)(addRect(0.0f, (-1.0f*yres), 50, yres*2, 0.0f, 0.2f, 2, (char *)"left wall portalable")))->SetAwake(false);//left wall
					 ((b2Body *)(addRect(xres*2.0f, (-1.0f*yres), 50, yres*2, 0.0f, 0.2f, 2, (char *)"right wall portalable")))->SetAwake(false);//right wall
					 ((b2Body *)(addRect(xres*9.4f, -150.0f, 20.0f, 300.0f, 0.0f, 0.2f, 2, (char *)"end", 180.0f)))->SetAwake(false);// end point
					 ...
					 turrets[0].max_angle = 135.0f;
					 turrets[0].min_angle = 45.0f;
					 turrets[0].angleSpeed = 0.5f;
					 turrets[1].turret = addTurret(b2Vec2(xres*2.0f-200, -yres), b2Vec2(50.0f, 100.0f), false, -45.0f, -90.0f, world);
